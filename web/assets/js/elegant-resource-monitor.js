import { MONITOR_SERVICE } from './elegant-resource-monitor-service.js'
...
class ElegantResourceMonitor extends HTMLElement {
  ...
  render() {
    this.innerHTML = `
      <link href="/extensions/ComfyUI-Elegant-Resource-Monitor/assets/css/material-icon.css" rel="stylesheet" />
